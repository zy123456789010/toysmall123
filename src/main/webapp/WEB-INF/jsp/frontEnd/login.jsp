            ...
            <div class="content-box first-content active">
                <form action="loginForName" method="post" id="loginForName" autocomplete="off">
                    <div class="login-i">
                        ...
                        <input style="color: black"  id="username" name="username" type="text" placeholder="请输入用户名" minlength="4" maxlength="16"/>
                    </div>
                    <label  class="tip tip-name"></label>
                    <div class="login-i">
                        <img src="images/frontEnd/password.png" alt="">
                        <input style="color: black" id="password" name="password" type="password" placeholder="请输入密码" minlength="6" maxlength="20"/>
                    </div>
